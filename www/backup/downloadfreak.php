...
function DOMinnerHTML1($element) 
{ 
    $innerHTML = ""; 
...
function getLinksFromSite1($link_url,$isGoogle){
	...
	**/
	...
	if($isGoogle){
	$search_results = getTags1($dom, "li","class","g");
...
$links=getLinksFromSite1("http://www.google.co.in/search?num=3&q=intitle:index.of+".urlencode($query)." mp3",true);
$finalLinks=array();
